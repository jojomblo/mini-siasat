...
// Enum untuk membedakan jenis aksi klik
...
class AttendanceSessionAdapter(
    ...
    // Listener diubah untuk menerima aksi
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (session.isOpen) {
            ...
            holder.status.setTextColor(ContextCompat.getColor(holder.itemView.context, R.color.warningRed))
